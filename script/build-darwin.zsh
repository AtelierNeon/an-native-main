...
MKTEMP_CLI=/usr/bin/mktemp
PROTOC_CLI=protoc
PWD_CLI=/bin/pwd
UNAME_CLI=/usr/bin/uname
UNZIP_CLI=/usr/bin/unzip
declare -A PROTOC_VER_ARCH_TO_ARCHIVE_NAME_MAP=(
        ["3.9.1_aarch64"]="protoc-3.9.1-osx-x86_64.zip"
        ["3.9.1_x86_64"]="protoc-3.9.1-osx-x86_64.zip"
)
...
PROJECT_CARES_WITHOUT_INSTALL_ALL="${MY_PROJECT_CARES_WITHOUT_INSTALL_ALL:=OFF}"
PROJECT_CARES_WITHOUT_INSTALL_FILES="${MY_PROJECT_CARES_WITHOUT_INSTALL_FILES:=OFF}"
PROJECT_CARES_WITHOUT_INSTALL_HEADERS="${MY_PROJECT_CARES_WITHOUT_INSTALL_HEADERS:=OFF}"
PROJECT_CARES_WITHOUT_INSTALL_LIBRARIES="${MY_PROJECT_CARES_WITHOUT_INSTALL_LIBRARIES:=OFF}"
PROJECT_CARES_WITHOUT_TEST_APPS="${MY_PROJECT_CARES_WITHOUT_TEST_APPS:=OFF}"
PROJECT_CJSON_WITHOUT_INSTALL_ALL="${MY_PROJECT_CJSON_WITHOUT_INSTALL_ALL:=OFF}"
PROJECT_CJSON_WITHOUT_INSTALL_FILES="${MY_PROJECT_CJSON_WITHOUT_INSTALL_FILES:=OFF}"
...
PROJECT_LIBSSH2_WITHOUT_INSTALL_ALL="${MY_PROJECT_LIBSSH2_WITHOUT_INSTALL_ALL:=OFF}"
PROJECT_LIBSSH2_WITHOUT_INSTALL_FILES="${MY_PROJECT_LIBSSH2_WITHOUT_INSTALL_FILES:=OFF}"
PROJECT_LIBSSH2_WITHOUT_INSTALL_HEADERS="${MY_PROJECT_LIBSSH2_WITHOUT_INSTALL_HEADERS:=OFF}"
PROJECT_LIBSSH2_WITHOUT_INSTALL_LIBRARIES="${MY_PROJECT_LIBSSH2_WITHOUT_INSTALL_LIBRARIES:=OFF}"
...
PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_ALL="${MY_PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_ALL:=OFF}"
PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_FILES="${MY_PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_FILES:=OFF}"
PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_HEADERS="${MY_PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_HEADERS:=OFF}"
PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_LIBRARIES="${MY_PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_LIBRARIES:=OFF}"
...
PROJECT_NGHTTP2_WITHOUT_INSTALL_ALL="${MY_PROJECT_NGHTTP2_WITHOUT_INSTALL_ALL:=OFF}"
PROJECT_NGHTTP2_WITHOUT_INSTALL_FILES="${MY_PROJECT_NGHTTP2_WITHOUT_INSTALL_FILES:=OFF}"
PROJECT_NGHTTP2_WITHOUT_INSTALL_HEADERS="${MY_PROJECT_NGHTTP2_WITHOUT_INSTALL_HEADERS:=OFF}"
PROJECT_NGHTTP2_WITHOUT_INSTALL_LIBRARIES="${MY_PROJECT_NGHTTP2_WITHOUT_INSTALL_LIBRARIES:=OFF}"
...
if [ "ON" = "$PROJECT_CARES_WITHOUT_INSTALL_ALL" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DCARES_WITHOUT_INSTALL_ALL=$PROJECT_CARES_WITHOUT_INSTALL_ALL")
fi
if [ "ON" = "$PROJECT_CARES_WITHOUT_INSTALL_FILES" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DCARES_WITHOUT_INSTALL_FILES=$PROJECT_CARES_WITHOUT_INSTALL_FILES")
fi
if [ "ON" = "$PROJECT_CARES_WITHOUT_INSTALL_HEADERS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DCARES_WITHOUT_INSTALL_HEADERS=$PROJECT_CARES_WITHOUT_INSTALL_HEADERS")
fi
if [ "ON" = "$PROJECT_CARES_WITHOUT_INSTALL_LIBRARIES" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DCARES_WITHOUT_INSTALL_LIBRARIES=$PROJECT_CARES_WITHOUT_INSTALL_LIBRARIES")
fi
...
if [ "ON" = "$PROJECT_CJSON_WITHOUT_INSTALL_ALL" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DCJSON_WITHOUT_INSTALL_ALL=$PROJECT_CJSON_WITHOUT_INSTALL_ALL")
fi
if [ "ON" = "$PROJECT_CJSON_WITHOUT_INSTALL_FILES" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DCJSON_WITHOUT_INSTALL_FILES=$PROJECT_CJSON_WITHOUT_INSTALL_FILES")
fi
if [ "ON" = "$PROJECT_CJSON_WITHOUT_INSTALL_HEADERS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DCJSON_WITHOUT_INSTALL_HEADERS=$PROJECT_CJSON_WITHOUT_INSTALL_HEADERS")
fi
if [ "ON" = "$PROJECT_CJSON_WITHOUT_INSTALL_LIBRARIES" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DCJSON_WITHOUT_INSTALL_LIBRARIES=$PROJECT_CJSON_WITHOUT_INSTALL_LIBRARIES")
fi
...
if [ "ON" = "$PROJECT_LIBSSH2_WITHOUT_INSTALL_ALL" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DLIBSSH2_WITHOUT_INSTALL_ALL=$PROJECT_LIBSSH2_WITHOUT_INSTALL_ALL")
fi
if [ "ON" = "$PROJECT_LIBSSH2_WITHOUT_INSTALL_FILES" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DLIBSSH2_WITHOUT_INSTALL_FILES=$PROJECT_LIBSSH2_WITHOUT_INSTALL_FILES")
fi
if [ "ON" = "$PROJECT_LIBSSH2_WITHOUT_INSTALL_HEADERS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DLIBSSH2_WITHOUT_INSTALL_HEADERS=$PROJECT_LIBSSH2_WITHOUT_INSTALL_HEADERS")
fi
if [ "ON" = "$PROJECT_LIBSSH2_WITHOUT_INSTALL_LIBRARIES" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DLIBSSH2_WITHOUT_INSTALL_LIBRARIES=$PROJECT_LIBSSH2_WITHOUT_INSTALL_LIBRARIES")
fi
...
if [ "ON" = "$PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_ALL" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DLIBWEBSOCKETS_WITHOUT_INSTALL_ALL=$PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_ALL")
fi
if [ "ON" = "$PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_FILES" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DLIBWEBSOCKETS_WITHOUT_INSTALL_FILES=$PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_FILES")
fi
if [ "ON" = "$PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_HEADERS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DLIBWEBSOCKETS_WITHOUT_INSTALL_HEADERS=$PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_HEADERS")
fi
if [ "ON" = "$PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_LIBRARIES" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DLIBWEBSOCKETS_WITHOUT_INSTALL_LIBRARIES=$PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_LIBRARIESS")
fi
...
if [ "ON" = "$PROJECT_NGHTTP2_WITHOUT_INSTALL_ALL" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DNGHTTP2_WITHOUT_INSTALL_ALL=$PROJECT_NGHTTP2_WITHOUT_INSTALL_ALL")
fi
if [ "ON" = "$PROJECT_NGHTTP2_WITHOUT_INSTALL_FILES" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DNGHTTP2_WITHOUT_INSTALL_FILES=$PROJECT_NGHTTP2_WITHOUT_INSTALL_FILES")
fi
if [ "ON" = "$PROJECT_NGHTTP2_WITHOUT_INSTALL_HEADERS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DNGHTTP2_WITHOUT_INSTALL_HEADERS=$PROJECT_NGHTTP2_WITHOUT_INSTALL_HEADERS")
fi
if [ "ON" = "$PROJECT_NGHTTP2_WITHOUT_INSTALL_LIBRARIES" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DNGHTTP2_WITHOUT_INSTALL_LIBRARIES=$PROJECT_NGHTTP2_WITHOUT_INSTALL_LIBRARIES")
fi
...
echo "[$SYSTEM_PLATFORM] Component information: c-ares without installing all artifacts: $PROJECT_CARES_WITHOUT_INSTALL_ALL"
echo "[$SYSTEM_PLATFORM] Component information: c-ares without installing files: $PROJECT_CARES_WITHOUT_INSTALL_FILES"
echo "[$SYSTEM_PLATFORM] Component information: c-ares without installing headers: $PROJECT_CARES_WITHOUT_INSTALL_HEADERS"
echo "[$SYSTEM_PLATFORM] Component information: c-ares without installing libraries: $PROJECT_CARES_WITHOUT_INSTALL_LIBRARIES"
echo "[$SYSTEM_PLATFORM] Component information: c-ares without test apps: $PROJECT_CARES_WITHOUT_TEST_APPS"
echo "[$SYSTEM_PLATFORM] Component information: cJSON without installing all artifacts: $PROJECT_CJSON_WITHOUT_INSTALL_ALL"
echo "[$SYSTEM_PLATFORM] Component information: cJSON without installing files: $PROJECT_CJSON_WITHOUT_INSTALL_FILES"
...
echo "[$SYSTEM_PLATFORM] Component information: libssh2 without installing all artifacts: $PROJECT_LIBSSH2_WITHOUT_INSTALL_ALL"
echo "[$SYSTEM_PLATFORM] Component information: libssh2 without installing files: $PROJECT_LIBSSH2_WITHOUT_INSTALL_FILES"
echo "[$SYSTEM_PLATFORM] Component information: libssh2 without installing headers: $PROJECT_LIBSSH2_WITHOUT_INSTALL_HEADERS"
echo "[$SYSTEM_PLATFORM] Component information: libssh2 without installing libraries: $PROJECT_LIBSSH2_WITHOUT_INSTALL_LIBRARIES"
...
echo "[$SYSTEM_PLATFORM] Component information: libwebsockets without installing all artifacts: $PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_ALL"
echo "[$SYSTEM_PLATFORM] Component information: libwebsockets without installing files: $PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_FILES"
echo "[$SYSTEM_PLATFORM] Component information: libwebsockets without installing headers: $PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_HEADERS"
echo "[$SYSTEM_PLATFORM] Component information: libwebsockets without installing libraries: $PROJECT_LIBWEBSOCKETS_WITHOUT_INSTALL_LIBRARIES"
...
echo "[$SYSTEM_PLATFORM] Component information: nghttp2 without installing all artifacts: $PROJECT_NGHTTP2_WITHOUT_INSTALL_ALL"
echo "[$SYSTEM_PLATFORM] Component information: nghttp2 without installing files: $PROJECT_NGHTTP2_WITHOUT_INSTALL_FILES"
echo "[$SYSTEM_PLATFORM] Component information: nghttp2 without installing headers: $PROJECT_NGHTTP2_WITHOUT_INSTALL_HEADERS"
echo "[$SYSTEM_PLATFORM] Component information: nghttp2 without installing libraries: $PROJECT_NGHTTP2_WITHOUT_INSTALL_LIBRARIES"
...
# Generate project
echo "[$SYSTEM_PLATFORM] Building project for arch $MY_DARWIN_ARCH_BUILD_LIST_STRING ..."
echo "[$SYSTEM_PLATFORM] Building project for arch $MY_DARWIN_ARCH_BUILD_LIST_STRING ... Generating project ..."
...
echo "[$SYSTEM_PLATFORM] Building project for arch $MY_DARWIN_ARCH_BUILD_LIST_STRING ... Generating project ... argument list: $MY_CMAKE_ARGUMENT_LIST_STRING"
$CMAKE_CLI $(echo $MY_CMAKE_ARGUMENT_LIST_STRING) 
MY_CHECK_RESULT=$?
if [ $MY_CHECK_RESULT -ne 0 ] ; then
    echo "[$SYSTEM_PLATFORM] Building project for arch $MY_DARWIN_ARCH_BUILD_LIST_STRING ... Generating project ... FAILED (ExitCode: $MY_CHECK_RESULT)"
    exit 1
fi
echo "[$SYSTEM_PLATFORM] Building project for arch $MY_DARWIN_ARCH_BUILD_LIST_STRING ... Generating project ... DONE"



# Compile project
echo "[$SYSTEM_PLATFORM] Building project for arch $MY_DARWIN_ARCH_BUILD_LIST_STRING ... Compiling project ..."
...
MY_CHECK_RESULT=$?
if [ $MY_CHECK_RESULT -ne 0 ] ; then
    echo "[$SYSTEM_PLATFORM] Building project for arch $MY_DARWIN_ARCH_BUILD_LIST_STRING ... Compiling project ... FAILED (ExitCode: $MY_CHECK_RESULT)"
    exit 1
fi
echo "[$SYSTEM_PLATFORM] Building project for arch $MY_DARWIN_ARCH_BUILD_LIST_STRING ... Compiling project ... DONE"



# Install project
echo "[$SYSTEM_PLATFORM] Building project for arch $MY_DARWIN_ARCH_BUILD_LIST_STRING ... Installing project ..."
$CMAKE_CLI --install $MY_TEMP_BUILD_DIR --config $PROJECT_RELEASE_TYPE
MY_CHECK_RESULT=$?
if [ $MY_CHECK_RESULT -ne 0 ] ; then
    echo "[$SYSTEM_PLATFORM] Building project for arch $MY_DARWIN_ARCH_BUILD_LIST_STRING ... Installing project ... FAILED (ExitCode: $MY_CHECK_RESULT)"
    exit 1
fi
echo "[$SYSTEM_PLATFORM] Building project for arch $MY_DARWIN_ARCH_BUILD_LIST_STRING ... Installing project ... DONE"
echo "[$SYSTEM_PLATFORM] Building project for arch $MY_DARWIN_ARCH_BUILD_LIST_STRING ... DONE"
